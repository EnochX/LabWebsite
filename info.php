...
?>
	...
	<link href="./includes/css/datepicker-style.css" rel="stylesheet">
			...
			<div class="page-header">
				<div class="container">
					<h3>通知公告<small class="pull-right hidden-xs"> <a href="./">首页</a> > <a class="active" href="#">通知公告</a></small></h3>
					<small class="visible-xs"> <a href="./">首页</a> > <a class="active" href="#">通知公告</a></small>
				...
				<div class="row blog">
					<div class="col-sm-8 blog-content">
						<div class="blog-post-item">
							<div class="row">
								<div class="col-sm-12">
									<h4><a href="blog-post.html">2017年端午节放假通知</a></h4>
						...
						<div class="blog-post-item">
							<div class="row">
								<div class="col-sm-12">
									<h4><a href="blog-post.html">lab369研讨会第四期--主题：异构计算集群变成模型</a></h4>
									<div class="blog-post-metadata">
										<span class="blog-post-date"><i class="icon-calendar"></i> 27/09/2012</span>
										<span class="blog-post-author"><i class="icon-pencil"></i> 编辑人</span>
									</div>
						...
						<div class="blog-post-item">
							<div class="row">
								<div class="col-sm-12">
									<h4><a href="blog-post.html">lab369研讨会第三期--主题：深度学习在图像语义分割中的应用</a></h4>
									<div class="blog-post-metadata">
										<span class="blog-post-date"><i class="icon-calendar"></i> 27/09/2012</span>
										<span class="blog-post-author"><i class="icon-pencil"></i> 编辑人</span>
									</div>
